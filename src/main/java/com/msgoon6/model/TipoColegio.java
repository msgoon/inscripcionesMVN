...
public class TipoColegio implements Serializable {
    ...
    public int getTipo_colegio_id() {
        return tipo_colegio_id;
    }

    public void setTipo_colegio_id(int tipo_colegio_id) {
        this.tipo_colegio_id = tipo_colegio_id;
    }
